...
| M23 | Delta Pro Direct Jet 2.0 MDB Auto-Import & Windows VM Automation | End-to-end automation of Microinvest Delta Pro database import; direct MDB table verification (T_OPERACII, T_DOKUMENTI, T_SMETKI); Windows VM hot-folder watcher / automated import runner; Building 11 production batch audit | M22 | DONE |
