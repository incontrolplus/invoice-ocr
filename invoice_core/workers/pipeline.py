...
from invoice_core.extraction.classification import (
    DocumentClassifier,
...
from invoice_core.currency import convert_bgn_to_eur, convert_eur_to_bgn
from invoice_core.extraction.extraction import (
    extract_dates,
    extract_due_date,
...
from invoice_core.extraction.financials import (
...
from invoice_core.ingestion import iter_document, load_document, pixmap_to_bgr
from invoice_core.ocr.layout import (
...
from invoice_core.ocr.ocr_passes import (
    build_raw_ocr_evidence,
    fuse_ocr_passes,
    normalize_ocr_tokens,
    run_multiple_ocr_passes,
)
from invoice_core.ocr.preprocessing import (
    binarize_otsu,
...
from invoice_core.ocr.tesseract_env import resolve_effective_ocr_lang, setup_tessdata_prefix
from invoice_core.extraction.validation import validate_contractor_eligibility, validate_invoice
...
def reconcile_party_with_contractor_master(
    ...
    from invoice_core.verification.partner_verification import compute_company_name_similarity
    ...
    if match_status == "DIVERGENT":
        ...
        from invoice_core.extraction.extraction import LEGAL_FORM_PATTERN
        if (
            not party.name
...
def _extract_and_validate_from_tokens(
    ...
    try:
        from invoice_core.accounting.accounting_engine import AccountingEngine
