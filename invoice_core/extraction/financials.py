...
from invoice_core.constants import DUAL_DISPLAY_END_DATE, EUR_MANDATORY_DATE, ZDDS_DISCOUNT_TOLERANCE
from invoice_core.currency import convert_bgn_to_eur, convert_eur_to_bgn, verify_dual_currency_parity
from .extraction import _is_metro_document, extract_dates
from invoice_core.ocr.layout import group_tokens_into_lines
from .models import (
    FinancialSummary,
    InvoiceMetadata,
    LogicalBlock,
...
from invoice_core.vendor_profiles import get_known_supplier_profiles, is_dot_matrix_vendor
...
def extract_payment_details(
    ...
    if pd.iban and len(pd.iban) == 22 and pd.iban.startswith("BG"):
        ...
        try:
            from invoice_core.accounting.legal_compliance import find_bank_by_code
